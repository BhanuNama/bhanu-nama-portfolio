...
```bash
git remote add encore encore://bhanu-nama-portfolio-gwp2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/bhanu-nama-portfolio-gwp2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/bhanu-nama-portfolio-gwp2/settings/integrations/github)
